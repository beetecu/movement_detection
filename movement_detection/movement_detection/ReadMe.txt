========================================================================
    APLICACIÓN DE CONSOLA: movement_detection Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación movement_detection.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación movement_detection.


movement_detection.vcxproj
...
movement_detection.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado movement_detection.pch y un archivo de tipos precompilados llamado StdAfx.obj.
